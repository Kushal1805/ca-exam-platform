...
async function extractQuestions() {
    ...
    try {
        ...
        const uploadResult = await fileManager.uploadFile('Business Law.pdf', {
            mimeType: 'application/pdf',
            displayName: 'Business Law Exam',
        });
...
`;
        ...
        fs.writeFileSync('BusinessLaw.json', JSON.stringify(questions, null, 2));
        console.log("Extracted Questions to BusinessLaw.json successfully!");
